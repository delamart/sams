...
class ViewLib {       
    ...
    public function setRaw() {
        return $this->raw_output = true;
    }

    public function unsetRaw() {
        return $this->raw_output = false;
    }
    ...
    public function _part($partial) {
        $tmpl = ConfigLib::g('directory/view') . DIRECTORY_SEPARATOR .
                $this->_controller . DIRECTORY_SEPARATOR .
                $this->_template . '-' . $partial . '.tmpl.php';
